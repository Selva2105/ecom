            ...
            <div className="flex h-[calc(100vh-80px)] items-center justify-center p-5 bg-white w-full">
                <div className="text-center">
                    <div className="inline-flex rounded-full bg-purple-100 p-4">
                        <div className="rounded-full stroke-purple-600 bg-purple-200 p-4">
                    ...
                    <Link to={'/'} className=""> <p className="text-slate-600 mt-5 lg:text-base flex flex-row items-center ga-4 justify-center"><RiArrowLeftDoubleLine className="text-purple-400 w-6 h-6" /> Go home
